...
please see the [documentation](https://godoc.org/github.com/Ownercz/semver).
...
If you find an issue or want to contribute please file an [issue](https://github.com/Ownercz/semver/issues)
or [create a pull request](https://github.com/Ownercz/semver/pulls).
