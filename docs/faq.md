...
These are works in progress, and may need some additional tuning. Please take a look at the [vcs package](https://github.com/ownercz/vcs). If you see a better way to handle it please let us know.
